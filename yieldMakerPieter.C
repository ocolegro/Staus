...
void yieldMakerPieter(){
    ...
    cutString += "&& (abs(dphi_l1l2) >= 1.5)";
    TString cutStringQCD = cutString;
    cutString += "&& (lep1_vtight == 1 && lep2_vtight == 1)";

    TString looseCut =   " && ( mt2 >= 90 ) ";//&& (TMath::Min(abs(dphi_l1met),abs(dphi_l2met)) >= .5)";

    TString medCut =   " &&  mt2 < 90 && mt2 >= 40 && pfmet > 50 && mt_sum < 350 && mt_sum > 300   ";

    TString tightCut =   " &&  mt2 < 90 && mt2 >= 40 && pfmet > 50 &&  mt_sum > 350 ";
    ...
    TString cutStringQCDSR1 = "fakeWeightVTight * (" + cutStringQCD + looseCut + ")";
    TString cutStringQCDSR2 = "fakeWeightVTight * (" + cutStringQCD + medCut + ")";
